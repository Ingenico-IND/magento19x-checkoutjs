...
class Ingenico_Ingenico_Block_Verification extends Mage_Adminhtml_Block_Template
{
    protected $data = null;
    ...
    public function __construct()
    {
        ...
        $this->setTemplate("ingenico/verification.phtml");
        parent::__construct();
    }

    public function getResultUrl()
    {
        return $this->getUrl('ingenico_admin/adminhtml_verificationresult');
    }
