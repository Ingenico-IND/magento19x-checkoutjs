...
class Worldline_Worldline_Block_Reconciliation extends Mage_Adminhtml_Block_Template
{
    protected $message = '';
    ...
    public function __construct()
    {
        ...
        $this->setTemplate("Worldline/reconciliation.phtml");
        parent::__construct();
    }

    public function getResultUrl()
    {
        return $this->getUrl('Worldline_admin/adminhtml_reconciliationresult');
    }
